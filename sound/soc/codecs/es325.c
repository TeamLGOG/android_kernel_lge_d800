...
#define CONFIG_SLIMBUS_DEVICE_UP_COND //                  
				       ...
				       struct snd_ctl_elem_value *ucontrol)
{
	...
	int rc = 0;
	struct es325_priv *es325 = &es325_priv;
	u8 vp_on_req_msg[4] 	= {0x90, 0x1c, 0x00, 0x01}; //      
	u8 vp_off_req_msg[4]	= {0x90, 0x1c, 0x00, 0x00}; //       
...
static const char *es325_internal_route_configs_text[ES325_STOP+1] = {
	...
	"TWO MIC FT VOIP",		/*                       */
	"ONE MIC HEADSET",		/*                       */
	"ONE CH MUSIC PLAYBACK",		/*                             */
	"TWO CH MUSIC PLAYBACK",	/*                             */
	"ONE MIC VOICE REC",		/*                         */
	"PRI MIC LOOPBACK",		/*                        */
	"SEC MIC LOOPBACK",		/*                        */
	"ONE MIC VIDEO REC",		/*                         */
