 ...
 *
 * $Id: dhd_linux.c 397155 2013-04-17 12:36:39Z $
 */
...
#define DHD_IDLETIME_TICKS_100MS 100
	dhd_bus_setidletime( dhd, \
			( dhd->op_mode & DHD_FLAG_HOSTAP_MODE ) ?
			(int)DHD_IDLETIME_TICKS_100MS : \
			(int)DHD_IDLETIME_TICKS );
#endif /*               */
