...
#ifdef CUST_G2_TOUCH
#define ANALOG_INTERFERENCE_METRIC_LSB_REG	0x04	/*          */
#define ANALOG_INTERFERENCE_METRIC_MSB_REG	0x05	/*          */
#define ANALOG_CURRENT_NOISE_STATE_REG		0x08	/*          */
#define ANALOG_CID_IM_REG					0x09	/*          */
#define ANALOG_FREQ_SCAN_IM_REG				0x0a	/*          */
#define ANALOG_IMAGE_METRIC_REG				0x0d	/*          */
#endif
