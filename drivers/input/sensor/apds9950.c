...
#define APDS9950_ALS_THRESHOLD_HSYTERESIS	20	/*          */

#define APDS9950_LUX_GA1	137  /*                                                 */
#define APDS9950_LUX_GA2	54   /*                                         */
#define APDS9950_LUX_GA3	138  /*                                                   */
#define APDS9950_CCT_GA1	909  /*                                                 */
#define APDS9950_CCT_GA2	381  /*                                         */
#define APDS9950_CCT_GA3	411  /*                                                   */
...
#define APDS9950_IOCTL_PS_GET_PDATA		3	/*       */
#define APDS9950_IOCTL_PS_POLL_DELAY		4
#define APDS9950_IOCTL_ALS_ENABLE		5
#define APDS9950_IOCTL_ALS_GET_ENABLE		6
#define APDS9950_IOCTL_ALS_GET_CDATA		7	/*       */
#define APDS9950_IOCTL_ALS_GET_RDATA		8	/*       */
#define APDS9950_IOCTL_ALS_GET_GDATA		9	/*       */
#define APDS9950_IOCTL_ALS_GET_BDATA		10	/*       */
...
#define APDS9950_ALS_POLL_SLOW			0	/*           */
#define APDS9950_ALS_POLL_MEDIUM		1	/*               */
#define APDS9950_ALS_POLL_FAST			2	/*              */
...
/*                               */
#define APDS9950_100MS_ADC_TIME	0xD6  /*                          */
#define APDS9950_50MS_ADC_TIME	0xEB  /*                         */
#define APDS9950_27MS_ADC_TIME	0xF6  /*                       */

/*                              */
#define APDS9950_PPERS_0	0x00  /*                           */
#define APDS9950_PPERS_1	0x10  /*                                            */
#define APDS9950_PPERS_2	0x20  /*                                            */
#define APDS9950_PPERS_3	0x30  /*                                            */
#define APDS9950_PPERS_4	0x40  /*                                            */
#define APDS9950_PPERS_5	0x50  /*                                            */
#define APDS9950_PPERS_6	0x60  /*                                            */
#define APDS9950_PPERS_7	0x70  /*                                            */
#define APDS9950_PPERS_8	0x80  /*                                            */
#define APDS9950_PPERS_9	0x90  /*                                            */
#define APDS9950_PPERS_10	0xA0  /*                                             */
#define APDS9950_PPERS_11	0xB0  /*                                             */
#define APDS9950_PPERS_12	0xC0  /*                                             */
#define APDS9950_PPERS_13	0xD0  /*                                             */
#define APDS9950_PPERS_14	0xE0  /*                                             */
#define APDS9950_PPERS_15	0xF0  /*                                             */

#define APDS9950_APERS_0	0x00  /*                 */
#define APDS9950_APERS_1	0x01  /*                                            */
#define APDS9950_APERS_2	0x02  /*                                            */
#define APDS9950_APERS_3	0x03  /*                                            */
#define APDS9950_APERS_5	0x04  /*                                            */
#define APDS9950_APERS_10	0x05  /*                                             */
#define APDS9950_APERS_15	0x06  /*                                             */
#define APDS9950_APERS_20	0x07  /*                                             */
#define APDS9950_APERS_25	0x08  /*                                             */
#define APDS9950_APERS_30	0x09  /*                                             */
#define APDS9950_APERS_35	0x0A  /*                                             */
#define APDS9950_APERS_40	0x0B  /*                                             */
#define APDS9950_APERS_45	0x0C  /*                                             */
#define APDS9950_APERS_50	0x0D  /*                                             */
#define APDS9950_APERS_55	0x0E  /*                                             */
#define APDS9950_APERS_60	0x0F  /*                                             */

/*                                 */
#define APDS9950_AGAIN_1X	0x00  /*             */
#define APDS9950_AGAIN_4X	0x01  /*             */
#define APDS9950_AGAIN_16X	0x02  /*              */
#define APDS9950_AGAIN_64X	0x03  /*              */

#define APDS9950_PRX_IR_DIOD	0x20  /*                          */

#define APDS9950_PGAIN_1X	0x00  /*            */
#define APDS9950_PGAIN_2X	0x04  /*            */
#define APDS9950_PGAIN_4X	0x08  /*            */
#define APDS9950_PGAIN_8X	0x0C  /*            */

#define APDS9950_PDRVIE_100MA	0x00  /*                    */
#define APDS9950_PDRVIE_50MA	0x40  /*                   */
#define APDS9950_PDRVIE_25MA	0x80  /*                   */
#define APDS9950_PDRVIE_12_5MA	0xC0  /*                     */


typedef enum {
    APDS9950_ALS_RES_24MS  = 0,    /*                       */
    APDS9950_ALS_RES_50MS  = 1,    /*                       */
    APDS9950_ALS_RES_100MS = 2	   /*                        */
} apds9950_als_res_e;

typedef enum {
    APDS9950_ALS_GAIN_1X    = 0,    /*          */
    APDS9950_ALS_GAIN_4X    = 1,    /*          */
    APDS9950_ALS_GAIN_16X   = 2,    /*           */
    APDS9950_ALS_GAIN_64X   = 3     /*           */
} apds9950_als_gain_e;
...
*/
static struct i2c_client *apds9950_i2c_client; /*                                    */
static struct workqueue_struct *apds9950_workqueue;

static unsigned char apds9950_als_atime_tb[] = { 0xF6, 0xEB, 0xD6 };
static unsigned short apds9950_als_integration_tb[] = {2400, 5040, 10080}; /*                           */
...
/*                                            */
static int RGB_COE_X[3] = {91, -352, -1560}; /*                                 */
static int RGB_COE_Y[3] = {6026, 6300, 3697}; /*                                */
static int RGB_COE_Z[3] = { -4930, -4541, -113}; /*                               */

static int RGB_CIE_N1 = 332; /*        */
static int RGB_CIE_N2 = 186; /*         */

static int RGB_CIE_CCT1 = 449; /*        */
static int RGB_CIE_CCT2 = 3525; /*         */
static int RGB_CIE_CCT3 = 6823; /*         */
static int RGB_CIE_CCT4 = 5520; /*          */
...
static void apds9950_change_als_threshold(struct i2c_client *client)
{
	...
	/*                         */
	if ((data->ps_detection == 1) && (data->cdata > (75 * (1024 * (256 - apds9950_als_atime_tb[data->als_atime_index]))) / 100)) {	/*                                            */
		/*                                                                      */
		input_report_abs(data->input_dev_ps, ABS_DISTANCE, 0);/*                       */
		input_sync(data->input_dev_ps);
	...
	if (data->als_data >= (apds9950_als_res_tb[data->als_atime_index] * 99) / 100) {
		...
		if (data->als_again_index != APDS9950_ALS_GAIN_1X) {
			...
			input_report_abs(data->input_dev_als, ABS_LIGHT, data->lux); /*                  */
...
static void apds9950_als_polling_work_handler(struct work_struct *work)
{
	...
	/*                         */
	if ((data->ps_detection == 1) && (data->cdata > (apds9950_als_res_tb[data->als_atime_index] * 95) / 100)) {	/*                                            */
		/*                                                                      */
		input_report_abs(data->input_dev_ps, ABS_DISTANCE, 0);/*                       */
		input_sync(data->input_dev_ps);
...
static void apds9950_work_handler(struct work_struct *work)
{
	...
	i2c_smbus_write_byte_data(client, CMD_BYTE | APDS9950_ENABLE_REG, 1);	/*                          */
	...
	if ((status & enable & 0x30) == 0x30) {
		...
		apds9950_set_command(client, 0);	/*                    */
	} else if ((status & enable & 0x10) == 0x10) {
		/*                         */
		apds9950_change_als_threshold(client);

		apds9950_set_command(client, 1);	/*                     */
	}
...
static int apds9950_enable_als_sensor(struct i2c_client *client, int val)
{
		...
		if (data->enable_als_sensor == 0) {
			...
			if (data->enable_als_sensor == APDS9950_ENABLE_ALS_NO_INT) {
				if (data->enable_ps_sensor) {
					apds9950_set_enable(client, 0x2F);	 /*                          */
				} else {
					apds9950_set_enable(client, 0x0B);	 /*             */
				}
    ...
    */
				...
				apds9950_set_ailt(client, 0xFFFF);	/*                                                               */
				apds9950_set_aiht(client, 0);

				if (data->enable_ps_sensor) {
					apds9950_set_enable(client, 0x3F);	 /*                                       */
				} else {
					apds9950_set_enable(client, 0x1B);	 /*                                        */
				}
    ...
    */
		...
		if (data->enable_ps_sensor) {
			...
			apds9950_set_enable(client, 0x2D);	 /*                                        */
		} else {
			apds9950_set_enable(client, 0);
		}
...
static int apds9950_enable_ps_sensor(struct i2c_client *client, int val)
{
   ...
   */
			...
			apds9950_set_enable(client, 0x13);	 /*                      */
		} else {	/*                      */
			apds9950_set_enable(client, 0);
...
static int apds9950_init_client(struct i2c_client *client)
{
	...
	err = apds9950_set_atime(client, apds9950_als_atime_tb[data->als_atime_index]);	/*                               */
	if (err < 0)
		return err;

	err = apds9950_set_ptime(client, 0xFF);	/*                             */
	if (err < 0)
		return err;

	err = apds9950_set_wtime(client, 0xF6);	/*                */
	if (err < 0)
		return err;
	...
	err = apds9950_set_config(client, 0);		/*              */
	if (err < 0)
		return err;
	...
	err = apds9950_set_pilt(client, 0);		/*                              */
	if (err < 0)
		return err;
	...
	err = apds9950_set_ailt(client, 0xFFFF);	/*                                                          */
	if (err < 0)
		return err;
	...
	err = apds9950_set_pers(client, APDS9950_PPERS_2 | APDS9950_APERS_2);	/*                                     */
	if (err < 0)
		return err;
				    ...
				    const struct i2c_device_id *id)
{
	...
	data->als_poll_delay = 100;	/*                  */
	data->als_atime_index = APDS9950_ALS_RES_100MS;	/*             */
	data->als_again_index = APDS9950_ALS_GAIN_1X;	/*          */
	data->als_prev_lux = 0;
