...
#define ABS_HUMIDITY		0x2B	/*                 */
#define ABS_TEMPERATURE		0x2C	/*                    */
...
static int sht21_input_init(struct sht21 *data)
{
	...
	input_set_abs_params(data->input_dev_humi, ABS_HUMIDITY, 0, 100, 0, 0);	/*          */
	input_set_abs_params(data->input_dev_temp, ABS_TEMPERATURE, -40, 120, 0, 0); /*             */
