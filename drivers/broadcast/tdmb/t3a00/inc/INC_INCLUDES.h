#ifndef _INC_T3A00_INCLUDES_H_
#define _INC_T3A00_INCLUDES_H_

//                                                      
#define INC_KERNEL_SPACE	//       
//                                      
//                               
//                                                      
...
/*                                                                              */
/*                                                                               */
#define INC_FW_VERSION		"T3A00_v1.00"
...
#define T3A00_SCAN_IF_DELAY				1500
#define T3A00_SCAN_RF_DELAY				1500
#define T3A00_PLAY_IF_DELAY				1000
#define T3A00_PLAY_RF_DELAY				1100
...
#define INC_T3A00_CHIP					0x3A00
#define INC_T3900_CHIP_ID				0xC00
#define INC_T3A00_CHIP_ID				0xE00
#define INC_T3A00_RF_REGISTER_MAX       208	

#define T3A00_SCAN_IF_PWR                     200
#define T3A00_PLAY_IF_PWR                     130
#define T3A00_IF_PWR_GAP                      30
...
//                                  
	...
	INC_UINT32		uiInCAntTick;
	INC_UINT32		uiInCVberTick;
...
{
	INC_UINT8	ucMsgGovernment;//               
	INC_UINT8	ucMsgID;				//               
	ST_DATE_T	stDate;					//    

	INC_INT8	acKinds[4];			//        
	INC_UINT8	cPrecedence;		//        
	INC_UINT32	ulTime;				//        
	INC_UINT8	ucForm;					//            
	INC_UINT8	ucResionCnt;		//           
	INC_UINT8	ucIsEWSGood;

	INC_UINT16	awUNICODE[EWS_OUTPUT_BUFF_MAX];
	INC_INT8	acTempBuff[EWS_OUTPUT_BUFF_MAX];	//                 
	INC_INT8	acEWSMessage[EWS_OUTPUT_BUFF_MAX];	//                 
