...
typedef unsigned long						LGD_DOUBLE32,		*LGD_PDOUBLE32;	//                                  
...
#define LGD_MPI_INTERRUPT_ENABLE 					0x0001	//              
#define LGD_I2C_INTERRUPT_ENABLE					0x0002	//              
#define LGD_EWS_INTERRUPT_ENABLE					0x0040	//              
#define LGD_REC_INTERRUPT_ENABLE					0x0080	//                         
#define LGD_TII_INTERRUPT_ENABLE					0x0100	//              
#define LGD_FIC_INTERRUPT_ENABLE					0x0200	//                             
#define LGD_CIFS_INTERRUPT_ENABLE					0x0400	//                    
#define LGD_FS_INTERRUPT_ENABLE						0x0800	//                      
#define LGD_EXT_INTERRUPT_ENABLE					0x1000	//                   
#define LGD_MS_INTERRUPT_ENABLE						0x2000	//                       
#define LGD_DPLLU_INTERRUPT_ENABLE					0x4000	//                      
#define LGD_SSI_INTERRUPT_ENABLE					0x8000	//                                    
...
#define LGD_INTERRUPT_SIZE				(188*16)	//             
...
{
	LGD_INT16			nSetCnt;
	LGD_CHANNEL_INFO	astSubChInfo[LGD_MULTI_MAX_CHANNEL];	//                                              
...
LGD_UINT8* LGD_GET_CHANNEL_FIFO_PTR(MULTI_CHANNEL_INFO ucIndex);		//                          
...
{
	LGD_UINT8	ucMsgGovernment;	//               
	LGD_UINT8	ucMsgID;			//               
	ST_DATE_T	stDate;				//    

	LGD_INT8	acKinds[4];			//        
	LGD_UINT8	cPrecedence;		//        
	LGD_UINT32	ulTime;				//        
	LGD_UINT8	ucForm;				//            
	LGD_UINT8	ucResionCnt;		//           
	LGD_UINT8	ucIsEWSGood;

	LGD_INT8	acTempBuff[EWS_OUTPUT_BUFF_MAX];	//                 
	LGD_INT8	acEWSMessage[EWS_OUTPUT_BUFF_MAX];	//                 
