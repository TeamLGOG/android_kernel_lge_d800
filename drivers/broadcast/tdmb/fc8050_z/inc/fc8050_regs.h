...
#ifdef TSIF
#define ENABLE_INT_MASK             (0x00)
#else
#define ENABLE_INT_MASK             (BBM_MF_INT)
#endif
...
//                                
//                                    
#define CH0_BUF_LENGTH				(188*16*4)
