...
//                                                                      
//              
#define T3900_DMB_INT_N           75	/*                     */			
#define T3900_DMB_RESET_N         94     /*                        */
#define T3900_DMB_EN              98    /*                          */
//                                                                     
...
static int tdmb_t3900_configure_gpios(void)
{
	...
	gpio_direction_output(T3900_DMB_EN, 0);  /*                */
	...
	gpio_direction_output(T3900_DMB_RESET_N, 0);  /*                */
