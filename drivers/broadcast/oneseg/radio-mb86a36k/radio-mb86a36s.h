...
#define	NODE_BASENAME		"/dev/mmbi_radio"	/*                  */
...
#define		PARAM_MACRO_PDOWN_DACPWDN_ON	0x10	/*                */
#define		PARAM_MACRO_PDOWN_ADCPWDNI_ON	0x01	/*                */
#define		PARAM_MACRO_PDOWN_ADCPWDNQ_ON	0x02	/*                */
