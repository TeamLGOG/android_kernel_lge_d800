...
#define	MB86A35_SELECT_UHF_13seg		2
#define	MB86A35_SELECT_UHF_1seg			3
...
#define	MB86A35_REG_ADDR_SOFT_PWDN		0xD8		/*                */	/*             */
...
#define	MB86A35_MASK_MACRO_PWDN_DACPWDN		0x13	/*            */	/*                     */
...
//         
MB86A35_RF_init_UHF_t RF_INIT_UHF_DATA_1seg[] = {
	{0x22, 0x80}, {0x23, 0x18}, 
	{0x25, 0xaa}, 
	...
	{0x5d, 0x1c}, {0x5e, 0x2a}, {0x5f, 0x32},
	{0x60, 0x49}, {0x61, 0x50}, {0x62, 0x51},
	{0x63, 0xd4}, {0x64, 0xf3}, {0x65, 0xff},
	{0x66, 0xff}, {0x67, 0xcc}, {0x68, 0x90},
	{0x69, 0x88}, {0x6a, 0x78}, {0x6b, 0x01},
	{0x6c, 0x21}, 
...
MB86A35_RF_init_UHF_t RF_INIT_UHF_DATA_13seg[] = {
	{0x22, 0x80}, {0x23, 0x18}, 
	{0x25, 0xaa}, 
	...
	{0x5d, 0x1c}, {0x5e, 0x2a}, {0x5f, 0x32},
	{0x60, 0x49}, {0x61, 0x50}, {0x62, 0x51},
	{0x63, 0xdd}, {0x64, 0xf5}, {0x65, 0xff},
	{0x66, 0xff}, {0x67, 0xfd}, {0x68, 0xd0},
	{0x69, 0x88}, {0x6a, 0x78}, {0x6b, 0x01},
	{0x6c, 0x21}, 
...
//                  
MB86A35_RF_init_UHF_t RF_INIT_VHF_DATA3[] = {
	{0x22, 0x00}, {0x23, 0x18}, 
	{0x25, 0xaa}, 
	...
	{0x5e, 0x2a}, {0x5f, 0x32}, {0x60, 0x49},
	{0x61, 0x63}, {0x62, 0x51}, {0x63, 0xd4},
	{0x64, 0xf3}, {0x65, 0xff}, {0x66, 0xff},
	{0x67, 0xcc}, {0x68, 0x90}, {0x69, 0x88},
	{0x6a, 0x78}, {0x6b, 0x01}, {0x6c, 0x20},
