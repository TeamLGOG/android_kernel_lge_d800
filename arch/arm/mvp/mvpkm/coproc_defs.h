 ...
 */
#define ARM_CP15_CRN_ID         0  //                                        
#define ARM_CP15_CRN_CNTL       1  //                            
#define ARM_CP15_CRN_PT         2  //                     
#define ARM_CP15_CRN_DACR       3  //                        
#define ARM_CP15_CRN_F_STATUS   5  //               
#define ARM_CP15_CRN_F_ADDR     6  //                
#define ARM_CP15_CRN_CACHE      7  //                             
#define ARM_CP15_CRN_TLB        8  //              
#define ARM_CP15_CRN_REMAP      10 //                         
#define ARM_CP15_CRN_SER        12 //                               
#define ARM_CP15_CRN_PID        13 //             
#define ARM_CP15_CRN_TIMER      14 //                      
