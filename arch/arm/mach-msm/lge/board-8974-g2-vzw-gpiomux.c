...
/*                                                         */
#if defined(CONFIG_BQ51051B_CHARGER) || defined(CONFIG_FTT_CHARGER_V3)
...
static struct msm_gpiomux_config wlc_charger_configs_a[] __initdata = {
	{
		.gpio = 44,
		.settings = {
...
static struct msm_gpiomux_config wlc_charger_configs_b[] __initdata = {
	{
		.gpio = 24,
		.settings = {
			[GPIOMUX_ACTIVE] = &wlc_track_act_cfg,
...
/*                                                         */
	...
	case HW_REV_A:
		msm_gpiomux_install(wlc_charger_configs_a,
				ARRAY_SIZE(wlc_charger_configs_a));
		break;
	case HW_REV_B:
	default:
		msm_gpiomux_install(wlc_charger_configs_b,
				ARRAY_SIZE(wlc_charger_configs_b));
	break;
	}
#endif
/*                                                         */
